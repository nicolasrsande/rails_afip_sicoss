module RailsAfipSicoss
  ...
  class Empleado < Fixy::Record
    ...
    field :apellido_nombre, 30, '12-41', :alphanumeric
    ...
    field :porcentaje_aporte_adicional_ss, 5, '54-58', :numeric
    ...
    field :remuneracion_total, 12, '70-81', :numeric_currency
    field :remuneracion_1, 12, '82-93', :numeric_currency
    field :asignaciones_familiares_pagadas, 9, '94-102', :numeric_currency
    field :importe_aporte_voluntario, 9, '103-111', :numeric_currency
    field :importe_adicional_os, 9, '112-120', :numeric_currency
    field :importe_exedente_aportes_ss, 9, '121-129', :numeric_currency
    field :importe_exedente_aportes_os, 9, '130-138', :numeric_currency
    field :provincia_localidad, 50, '139-188', :alphanumeric
    field :remuneracion_2, 12, '189-200', :numeric_currency
    field :remuneracion_3, 12, '201-212', :numeric_currency
    field :remuneracion_4, 12, '213-224', :numeric_currency
    field :codigo_siniestrado, 2, '225-226', :numeric
    field :corresponde_reduccion, 1, '227-227', :alphanumeric
    field :capital_recomposicion_lrt, 9, '228-236', :numeric_currency
    field :tipo_empresa, 1, '237-237', :numeric
    field :aporte_adicional_obra_social, 9, '238-246', :numeric_currency
    ...
    field :sueldo_adicionales, 12, '260-271', :numeric_currency
    field :sac, 12, '272-283', :numeric_currency
    field :horas_extra, 12, '284-295', :numeric_currency
    field :zona_desfavorable, 12, '296-307', :numeric_currency
    field :vacaciones, 12, '308-319', :numeric_currency
    field :dias_trabajdos, 9, '320-328', :numeric
    field :remuneracion_5, 12, '329-340', :numeric_currency
    field :trabajador_convencionado, 1, '341-341', :alphanumeric
    field :remuneracion_6, 12, '342-353', :numeric_currency
    field :tipo_operacion, 1, '354-354', :numeric
    field :adicionales, 12, '355-366', :numeric_currency
    field :premios, 12, '367-378', :numeric_currency
    field :remuneracion_8, 12, '379-390', :numeric_currency
    field :remuneracion_7, 12, '391-402', :numeric_currency
    field :cantidad_horas_extra, 3, '403-405', :numeric
    field :no_remunerativo, 12, '406-417', :numeric_currency
    field :maternidad, 12, '418-429', :numeric_currency
    field :rectificacion_remuneracion, 9, '430-438', :numeric_currency
    field :remuneracion_9, 12, '439-450', :numeric_currency
    field :contribucion_tarea_diferencial, 9, '451-459', :numeric_currency
    field :horas_trabajadas, 3, '460-462', :numeric
    field :scvo, 1, '463-463', :alphanumeric
    field :detraccion_ley27430, 12, '464-475', :numeric_currency
    field :incremento_salarial, 12, '476-487', :numeric_currency
    field :remuneracion_11, 12, '488-499', :numeric_currency
    ...
    def initialize(employee_settlement)
      ...
      @zona_desfavorable = employee_settlement[:zona_desfavorable] || 0
      @tipo_operacion = employee_settlement[:tipo_operacion] || 0

      ## Declaracion de sueldos y remuenraciones
      ...
      @horas_extra = employee_settlement || 0 # Horas Extra
      @maternidad = employee_settlement[:maternidad] || 0
      ...
      @detraccion_ley27430 = employee_settlement[:detraccion_ley27430] || 7003.68 #Importe a detraer - Modifica Rem. 10
    ...
    def rem_total
      @sueldo_adicionales + @incremento_salarial + @vacaciones + @sac + @adicionales + @premios + @no_remunerativo + @horas_extra + @maternidad
    end
